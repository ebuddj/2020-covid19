...
const numberOfContinents = 6,
      ...
      dataSets = [{backgroundColor:'',borderColor:'#f63c00',borderWidth:7,data:[],fill:false,label:'Asia',radius:0,order:99},{backgroundColor:'',borderColor:'#c30000',borderWidth:7,data:[],fill:false,label:'Europe',radius:0,order:99},{backgroundColor:'',borderColor:'#00ce00',borderWidth:7,data:[],fill:false,label:'North America',radius:0,order:99},{backgroundColor:'',borderColor:'#008100',borderWidth:7,data:[],fill:false,label:'South America',radius:0,order:99},{backgroundColor:'',borderColor:'#ffd600',borderWidth:7,data:[],fill:false,label:'Africa',radius:0,order:99},{backgroundColor:'',borderColor:'#c23d80',borderWidth:7,data:[],fill:false,label:'Oceania',radius:0,order:99}];
...
class App extends Component {
  ...
  createLineChart(ratio, filename) {
    ...
    let line_chart = new Chart(this.lineChartRef.current.getContext('2d'), options);
  ...
  loadData(line_chart, filename) {
    ...
    d3.csv('./data/data - ' + filename + '.csv').then((data) => {
      ...
      this.addData(data, current_continent_idx, line_chart);
      this.appRef.current.style.display = 'block';
    });
  }
  addData(data, current_continent_idx, line_chart) {
